...
\begin{equation}\label{eqdeltap}
\gls{deltap}= \frac{\gls{G}^{2} \gls{nu}_{\gls{in}}}{2} \left[ \left( 1 + \gls{beta}^{2} \right) \left( \frac{\gls{nu}_{\gls{out}}}{\gls{nu}_{\gls{in}}} -1\right) + \gls{f} \frac{\gls{A}}{\beta \gls{A}_{\gls{fr}}} \frac{\gls{nu}_m}{\gls{nu}_{\gls{in}}} \right]
\end{equation}
