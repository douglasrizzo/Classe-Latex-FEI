...
\end{table}
    ...
    \subsection{\texttt{\textbackslash anexos}} \label{sub:anexos}
    Ao contrário dos apêndices, o \LaTeX\ não possui um comando nativo para tratar anexos. Para isso, foi criado o comando \latexinline+\anexos+ que transforma os capítulos subsequentes em anexos.
