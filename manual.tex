...
\section{Pacotes necessários}\label{sec:pacotes}
    ...
    \begin{enumerate}
        ...
        \item\verb+\index{ABNT}\gls{abnt}ex2cite+: formata citações e referências de acordo com o padrão \index{ABNT}\gls{abnt} 6023.
    \end{enumerate}
...
\chapter{REFERÊNCIA USANDO O abn\TeX}\label{chap:referencia}
	...
	Para a criação de índices remissivos, foi importado o pacote \verb+imakeidx+. Este pacote utiliza o programa \verb+xindy+ na criação de arquivos auxiliares que indexam as palavras a serem colocadas no índice. Portanto, é necessário ter o \verb+xindy+ instalado para que a compilação tenha sucesso.
	...
	Repare que, no caso das siglas, quando estas são usadas pela primeira vez, são impressas a definição seguida da sigla entre parênteses. Nas demais vezes, a sigla aparecerá sozinha.
