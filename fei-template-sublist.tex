\documentclass[rascunho,sublist]{fei}
...
% Padroes: Sao Bernardo do Campo / Centro Universitario da FEI - especificar caso necessario alterar
%\cidade{Cidade}
...
% \cidade{Cidade}
% \instituicao{Instituição de Ensino}
>>>>>>> cb5e6ea340facb8e57ec2625453b08339ab8c736
...
\maketitle
\begin{folhaderosto}
Dissertação de Mestrado apresentada ao Centro Universitário da FEI para obtenção do título de Mestre em Engenharia Elétrica, orientado pelo Prof. Dr. Nome do Orientador. 
\end{folhaderosto}
\fichacatalografica
\folhadeaprovacao
